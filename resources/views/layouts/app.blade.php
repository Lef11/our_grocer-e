...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="front-end/css/open-iconic-bootstrap.min.css">
    ...
    <link rel="stylesheet" href="front-end/css/jquery.timepicker.css">
