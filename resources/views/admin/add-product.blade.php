      ...
      <div class="card">
        <div class="card-body">
          <h4 class="card-title">Create product</h4>
            {!!Form::open(['action' => 'ProductController@saveProduct', 'class' => 'cmxform', 'method' => 'POST', 'id' => 'commentForm', 'enctype' => 'multypart/form-data'])!!}
            {{csrf_field()}}
              <div class="form-group">
                ...
                <div class="form-group">
                    {{Form::label('', 'Product Price', ['for' => 'cnamel'])}}
                    {{Form::number('product_price', '', ['class' => 'form-control'])}}
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                {{Form::label('', 'Product Status', ['for' => 'cnamel'])}}
...
@endsection
@section('scripts')
<script src="{{asset('back-end/js/bt-maxLength.js')}}"></script>
@endsection
